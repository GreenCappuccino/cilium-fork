...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *CiliumEnvoyHTTPFilter) DeepEqual(other *CiliumEnvoyHTTPFilter) bool {
	if other == nil {
		return false
	}
...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *CiliumEnvoyHTTPFilterSpec) DeepEqual(other *CiliumEnvoyHTTPFilterSpec) bool {
	if other == nil {
		return false
	}

	if ((in.HTTPFilters != nil) && (other.HTTPFilters != nil)) || ((in.HTTPFilters == nil) != (other.HTTPFilters == nil)) {
		in, other := &in.HTTPFilters, &other.HTTPFilters
		if other == nil {
			return false
		}
...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *HTTPFilter) DeepEqual(other *HTTPFilter) bool {
	if other == nil {
		return false
	}
	...
	if !in.TypedConfig.DeepEqual(&other.TypedConfig) {
		return false
	}

	if !in.ConfigDiscovery.DeepEqual(&other.ConfigDiscovery) {
		return false
	}

	if in.IsOptional != other.IsOptional {
		return false
	}
	if in.Disabled != other.Disabled {
		return false
