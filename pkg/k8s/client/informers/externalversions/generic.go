...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	case v2alpha1.SchemeGroupVersion.WithResource("ciliumenvoyhttpfilters"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Cilium().V2alpha1().CiliumEnvoyHTTPFilters().Informer()}, nil
