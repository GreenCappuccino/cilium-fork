...
func (c *CiliumV2alpha1Client) CiliumEnvoyHTTPFilters(namespace string) CiliumEnvoyHTTPFilterInterface {
	return newCiliumEnvoyHTTPFilters(c, namespace)
}
